...
\date{Generated on 2026-03-06 02:51 }
...
\item {} \textbf{\emph{bond\_\allowbreak{}price}} — Calculate bond pricing, valuation, and analytics. Accepts ISIN, RIC, CUSIP, or AssetId. Returns yield, duration, convexity, DV01, accrued interest. Supports what-if scenarios via price/yield overrides.
\item {} \textbf{\emph{bond\_\allowbreak{}future\_\allowbreak{}price}} — Calculate bond future pricing and analytics. Returns fair value, cheapest-to-deliver identification, delivery basket, conversion factors, and contract DV01.
\end{itemize}

\subparagraph{FX Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{fx\_\allowbreak{}spot\_\allowbreak{}price}} — FX spot rate pricing for ISO currency pairs. Returns mid/bid/ask rates.
\item {} \textbf{\emph{fx\_\allowbreak{}forward\_\allowbreak{}price}} — FX forward rate pricing at specific tenors or dates. Returns forward points, outright rates, and carry.
\end{itemize}

\subparagraph{Curves Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government yield curves. Two-phase: list available curves, then calculate curve points. Returns par/zero rates, discount factors, forward rates.
\item {} \textbf{\emph{credit\_\allowbreak{}curve}} — Credit spread curves. Search by country and issuer type (Corporate, Sovereign, Agency, etc.), then calculate spread term structure.
\item {} \textbf{\emph{inflation\_\allowbreak{}curve}} — Inflation breakeven curves. Search by country/currency, then calculate breakeven rates and real yields.
\item {} \textbf{\emph{fx\_\allowbreak{}forward\_\allowbreak{}curve}} — FX forward point curves. List curves, then calculate forward points across all standard tenors.
\end{itemize}

\subparagraph{Swaps Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{ir\_\allowbreak{}swap}} — Interest rate swap pricing. Two-phase: list templates by currency/index, then price swaps at specified tenors. Returns par rates, DV01, NPV.
\end{itemize}

\subparagraph{Options Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{option\_\allowbreak{}value}} — Option valuation supporting vanilla, barrier, binary, and Asian options. Returns premium, full Greeks (delta, gamma, vega, theta, rho), and risk metrics.
\item {} \textbf{\emph{option\_\allowbreak{}template\_\allowbreak{}list}} — List available option templates for pricing.
\end{itemize}

\subparagraph{Volatility Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{fx\_\allowbreak{}vol\_\allowbreak{}surface}} — FX volatility surface generation using SABR model. Returns vol surface across tenors and delta strikes.
\item {} \textbf{\emph{equity\_\allowbreak{}vol\_\allowbreak{}surface}} — Equity implied volatility surface. Supports equities/indices via RIC and futures via RICROOT.
\end{itemize}

\subparagraph{Quantitative Analytics Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{qa\_\allowbreak{}ibes\_\allowbreak{}consensus}} — IBES analyst consensus estimates (EPS, revenue, EBITDA, DPS). Forward-looking estimates with analyst count, dispersion, and high/low ranges.
\item {} \textbf{\emph{qa\_\allowbreak{}company\_\allowbreak{}fundamentals}} — Reported company financials (income statement, balance sheet metrics). Historical fiscal year data.
\item {} \textbf{\emph{qa\_\allowbreak{}historical\_\allowbreak{}equity\_\allowbreak{}price}} — Historical equity prices with OHLCV, total returns, and beta.
\item {} \textbf{\emph{qa\_\allowbreak{}macroeconomic}} — Macroeconomic indicators database. Search by mnemonic or description, retrieve latest values or time series.
\end{itemize}

\subparagraph{Time Series Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical pricing summaries for any RIC. Supports interday (daily, weekly, monthly) and intraday (1min to 1hr) intervals.
\end{itemize}

\subparagraph{Fixed Income Analytics (YieldBook) Domain}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{yieldbook\_\allowbreak{}bond\_\allowbreak{}reference}} — Bond reference data: security type, sector, ratings, coupon, maturity, issuer.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}cashflow}} — Bond cashflow projections: future coupon and principal payment schedules.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}scenario}} — Bond scenario analysis: price/yield under parallel rate shifts.
\item {} \textbf{\emph{fixed\_\allowbreak{}income\_\allowbreak{}risk\_\allowbreak{}analytics}} — Bond risk analytics: OAS, effective duration, key rate durations, convexity.
\end{itemize}
...
{} argument-hint &  [timeframe e.g. 5Y] \\
\bottomrule
\end{longtable}
\endgroup
...
{} argument-hint &  [period e.g. FY2024-FY2026] \\
\bottomrule
\end{longtable}
\endgroup
...
{} argument-hint &  [scenario e.g. +100bp] \\
\bottomrule
\end{longtable}
\endgroup
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{bond\_\allowbreak{}future\_\allowbreak{}price}} — Price bond futures. Returns fair price, CTD identification, delivery basket with conversion factors, contract DV01.
\item {} \textbf{\emph{bond\_\allowbreak{}price}} — Price individual cash bonds. Returns clean/dirty price, yield, duration, DV01, convexity.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government yield curves. Two-phase: list available curves, then calculate. Use short end as repo rate proxy.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical OHLC data for futures and bonds. Use to track basis evolution over time.
\item {} \textbf{\emph{credit\_\allowbreak{}curve}} — Credit spread curves. Use for sovereign credit context when relevant.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{bond\_\allowbreak{}price}} — Price bonds. Returns clean/dirty price, yield, duration, convexity, DV01, Z-spread. Accepts ISIN, RIC, or CUSIP.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government and swap yield curves. Two-phase: list then calculate. Use to compute G-spreads.
\item {} \textbf{\emph{credit\_\allowbreak{}curve}} — Credit spread curves by issuer type. Two-phase: search by country/issuerType, then calculate. Use to isolate credit component.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}scenario}} — Scenario analysis with parallel rate shifts. Returns price change and P\&L under each scenario.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical pricing data. Use for historical spread context and Z-score analysis.
\item {} \textbf{\emph{fixed\_\allowbreak{}income\_\allowbreak{}risk\_\allowbreak{}analytics}} — OAS, effective duration, key rate durations. Use for callable bonds and deeper risk decomposition.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{qa\_\allowbreak{}ibes\_\allowbreak{}consensus}} — IBES analyst consensus estimates and actuals. Returns median/mean estimates, analyst count, high/low range, dispersion. Supports EPS, Revenue, EBITDA, DPS.
\item {} \textbf{\emph{qa\_\allowbreak{}company\_\allowbreak{}fundamentals}} — Reported financials: income statement, balance sheet, cash flow. Historical fiscal year data for ratio analysis.
\item {} \textbf{\emph{qa\_\allowbreak{}historical\_\allowbreak{}equity\_\allowbreak{}price}} — Historical equity prices with OHLCV, total returns, and beta.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical pricing summaries (daily, weekly, monthly). Alternative/supplement for price history.
\item {} \textbf{\emph{qa\_\allowbreak{}macroeconomic}} — Macro indicators (GDP, CPI, unemployment, PMI). Use to establish the economic backdrop for the company's sector.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{bond\_\allowbreak{}price}} — Price bonds. Returns clean/dirty price, yield, duration, convexity, DV01, spread. Accepts comma-separated identifiers for batch pricing.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}bond\_\allowbreak{}reference}} — Bond reference data: issuer, coupon, maturity, rating, sector, currency, call provisions.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}cashflow}} — Cashflow projections: future coupon and principal payment schedules.
\item {} \textbf{\emph{yieldbook\_\allowbreak{}scenario}} — Scenario analysis: price/yield under parallel rate shifts and curve scenarios.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government yield curves. Use for spread-to-curve context and curve environment assessment.
\item {} \textbf{\emph{fixed\_\allowbreak{}income\_\allowbreak{}risk\_\allowbreak{}analytics}} — OAS, effective duration, key rate durations, convexity. Use for bonds with embedded options.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{fx\_\allowbreak{}spot\_\allowbreak{}price}} — Current spot rate for a currency pair. Returns mid/bid/ask. Starting point for all carry analysis.
\item {} \textbf{\emph{fx\_\allowbreak{}forward\_\allowbreak{}price}} — Forward rate at a specific tenor. Returns forward points and outright rate. Use to compute carry at the target tenor.
\item {} \textbf{\emph{fx\_\allowbreak{}forward\_\allowbreak{}curve}} — Full forward curve across all standard tenors. Two-phase: list then calculate. Use to map the carry term structure.
\item {} \textbf{\emph{fx\_\allowbreak{}vol\_\allowbreak{}surface}} — Implied volatility surface by delta and expiry. Returns ATM vol, risk reversals, butterflies. Use for carry-to-vol ratio and skew assessment.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical spot price data. Use to compute realized vol and assess spot trend direction.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Yield curves by currency. Use to understand the rate differential driving the carry.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{qa\_\allowbreak{}macroeconomic}} — Macro data series: GDP, CPI, PCE, unemployment, payrolls, PMI, retail sales. Multiple countries and frequencies. Search by mnemonic pattern or description.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government yield curves and swap curves. Two-phase: list then calculate. Use for curve shape and slope analysis.
\item {} \textbf{\emph{inflation\_\allowbreak{}curve}} — Inflation breakeven curves and real yields. Two-phase: search then calculate. Use for real rate decomposition.
\item {} \textbf{\emph{ir\_\allowbreak{}swap}} — Swap rates by tenor and currency. Two-phase: list templates then price. Use to compute swap spreads.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical pricing data. Use for historical yield context and trend analysis.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{equity\_\allowbreak{}vol\_\allowbreak{}surface}} — Implied vol surface for equities/indices. Input: RIC (e.g., ``.SPX@RIC'') or RICROOT (e.g., ``ES@RICROOT''). Returns vol by strike/delta and expiry.
\item {} \textbf{\emph{fx\_\allowbreak{}vol\_\allowbreak{}surface}} — Implied vol surface for FX pairs. Input: currency pair (e.g., ``EURUSD''). Returns vol by delta and expiry. FX surfaces are quoted in delta space.
\item {} \textbf{\emph{option\_\allowbreak{}value}} — Price individual options with full Greeks (delta, gamma, vega, theta, rho). Use after identifying specific strikes from the vol surface.
\item {} \textbf{\emph{option\_\allowbreak{}template\_\allowbreak{}list}} — Discover available option templates for an underlying. Use to find valid expiries and strikes before pricing.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical OHLC data. Use to compute realized vol from price history.
\item {} \textbf{\emph{qa\_\allowbreak{}historical\_\allowbreak{}equity\_\allowbreak{}price}} — Historical equity prices. Alternative source for realized vol computation.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{\emph{ir\_\allowbreak{}swap}} — Swap pricing. Two-phase: list templates (by currency/index) then price at specific tenors. Returns par swap rate, DV01, NPV.
\item {} \textbf{\emph{interest\_\allowbreak{}rate\_\allowbreak{}curve}} — Government yield curves. Two-phase: list then calculate. Use for swap spread computation and curve shape context.
\item {} \textbf{\emph{inflation\_\allowbreak{}curve}} — Inflation breakeven curves. Two-phase: search then calculate. Use for real rate decomposition.
\item {} \textbf{\emph{tscc\_\allowbreak{}historical\_\allowbreak{}pricing\_\allowbreak{}summaries}} — Historical pricing data. Use for historical curve slope context and trend analysis.
\item {} \textbf{\emph{qa\_\allowbreak{}macroeconomic}} — Macro data. Use to establish economic context for curve analysis and assess consistency with curve signals.
\end{itemize}
...
\textbf{Hyperlink Rule (STRICTLY ENFORCED):} Every claim in the report — numeric AND non-numeric — MUST be wrapped in an `\emph{ hyperlink pointing to the corresponding entry in the Appendix. **This is not optional. Every single number in the report must be a clickable link.** This includes: revenue figures, EPS, margins, growth rates, market caps, P/E ratios, stock returns, price targets, segment revenue, and any other financial metric. It also includes qualitative claims from transcripts or Kensho searches. If you state it as fact, it must link to a source. Assign each unique claim a sequential reference ID (}ref-1\emph{, }ref-2\emph{, etc.). The hyperlink style is subtle — navy color, no underline, dotted underline on hover. **Do NOT write any number in the report body without wrapping it in an }\emph{ tag.** Example: write }\$152.3B\emph{, NEVER write }\$152.3B` as plain text.
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} Loads and runs JavaScript needed for dynamic report visuals.
...
\begin{enumerate}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{Header banner} — immediately before the cover header, as a centered yellow banner: \emph{Analysis is AI-generated — please confirm all outputs}
\item {} \textbf{Footer} — inside the page-footer div, as a prominent yellow banner: \emph{Analysis is AI-generated — please confirm all outputs}
\item {} \textbf{Appendix} — as the first line of the appendix section, before the table: \emph{Analysis is AI-generated — please confirm all outputs}
\end{enumerate}
...
The appendix MUST begin with the AI disclaimer banner: \emph{Analysis is AI-generated — please confirm all outputs}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} State the MCP function used and its key parameters. Format: \emph{S\&P Capital IQ — \href{identifier='[TICKER]', line\_\allowbreak{}item='[item]', period\_\allowbreak{}type='[type]', period='[Q\# FY\#\#\#\#]'}{function\_\allowbreak{}name}}
\item {} Examples:
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
...
\item {} Show the full formula with \textbf{hyperlinked components} — each component must be an `` link back to the appendix row for that raw data point. This is critical: the reader must be able to click through from the calculated value to each of its inputs.
\item {} Example: \emph{Gross Margin = Gross Profit \$37.2B / Revenue \$152.3B = 24.4\%. Source: S\&P Capital IQ (calculated)}
\item {} Example: \emph{LTM P/E = Price \$172.35 / (Q1 EPS \$1.47 + Q2 EPS \$1.84 + Q3 EPS \$1.53 + Q4 EPS \$1.80) = \$172.35 / \$6.64 = 25.9x}
\item {} Example: \emph{Revenue y/y growth = (Q3 FY26 Rev \$165.8B - Q3 FY25 Rev \$160.8B) / Q3 FY25 Rev \$160.8B = +3.1\%}
...
\item {} \textbf{MANDATORY: Include the source URL} returned by the Kensho \emph{search} tool as a clickable `` hyperlink. This is the most important part — readers must be able to click through to the original source.
\item {} Format: \emph{``[finding/excerpt]'' — [Source Title or Publication]. Query: search(``[query used]'')}
\item {} Example: \emph{``Barclays upgraded WMT to Overweight with \$210 price target on Jan 15, 2026.'' — Investing.com, Jan 15 2026. Query: search(``WMT analyst ratings price target upgrades downgrades'')}
...
\item {} \textbf{Hyperlinked claims}: Every factual claim — numeric or qualitative — must be an `\emph{ tag linking to its appendix entry. Numbers: }\$152.3B\emph{. Qualitative: }management flagged tariff headwinds as the primary margin risk`. No fact should appear without a traceable source in the appendix.
\end{itemize}
...
\textbf{Web Template Summary}
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} Includes a full HTML document scaffold (doctype, head, and body).
\item {} Defines embedded CSS, including print-oriented layout and typography rules.
\item {} Configures Chart.js usage, including plugin registration and chart rendering behavior.
\item {} Implements reusable chart helper functions for consistent figure generation.
\item {} Contains HTML table structures for presenting formatted metric outputs.
\item {} Defines canvas placeholders for interactive chart components.
\item {} Loads and runs JavaScript needed for dynamic report visuals.
\item {} HTML/CSS/JavaScript implementation lines are intentionally omitted in print output for readability.
\end{itemize}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} Every factual claim in the report body — numbers AND qualitative statements — must be wrapped in \emph{CLAIM TEXT}
...
\item {} For qualitative claims, wrap the key phrase: \emph{management flagged tariff headwinds}
\end{itemize}

\subparagraph{Appendix}\mbox{}\par
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{MUST begin with}: \emph{Analysis is AI-generated — please confirm all outputs}
...
\item {} \textbf{Every number in the report body must be a clickable `` link to its appendix row. No exceptions.}
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} For raw S\&P data (revenue, EPS, prices, market cap, etc.): \emph{S\&P Capital IQ} followed by the specific MCP function call with parameters (e.g., \emph{get\_\allowbreak{}financial\_\allowbreak{}line\_\allowbreak{}item\_\allowbreak{}from\_\allowbreak{}identifiers(identifier='WMT', line\_\allowbreak{}item='revenue', period\_\allowbreak{}type='quarterly', period='Q3 FY2026')}). \textbf{Never write just ``S\&P Capital IQ'' with no detail.}
\item {} For calculated values (margins, growth rates, P/E, returns): the full formula with `\emph{ hyperlinks to each component row (use }formula` CSS class). \textbf{Every number in the formula must be a clickable link to its own appendix row.}
...
\item {} For Kensho results: the key finding (\emph{excerpt} class) + \textbf{clickable source URL} as \emph{[Source Title]} + the search query used. \textbf{Every Kensho-sourced claim must have a clickable URL to the original source.}
\end{itemize}
...
\item {} Management quotes: Integrate as `` elements within the executive thesis narrative. Never under a separate heading.
...
\item {} \textbf{What is the \emph{status} field?}
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
...
\item {} \textbf{\emph{get\_\allowbreak{}funding\_\allowbreak{}summary\_\allowbreak{}from\_\allowbreak{}identifiers} errors or returns zeros:} Fall back to \emph{get\_\allowbreak{}rounds\_\allowbreak{}of\_\allowbreak{}funding\_\allowbreak{}from\_\allowbreak{}identifiers} — the summary tool is less reliable. Never rely on the summary tool as the sole data source.
\item {} \textbf{Wrong \emph{role} parameter:} If investor-perspective queries return empty, verify you're using \emph{company\_\allowbreak{}investing\_\allowbreak{}in\_\allowbreak{}round\_\allowbreak{}of\_\allowbreak{}funding}, not \emph{company\_\allowbreak{}raising\_\allowbreak{}funds} (and vice versa).
\end{itemize}
