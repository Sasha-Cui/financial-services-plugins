...
\textbf{Implementation:} Apply custom number format \emph{[Red][<>0]0.00;[Red]@@TOKEN0@@;0.00} or use Excel conditional formatting with the rule ``Cell Value ≠ 0'' → Red font.
...
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} \textbf{@@TOKEN0@@} — Table templates for M\&A transactions, scenario analysis, and slide structure. Reference when building financial tables or investment scenarios.
\item {} \textbf{@@TOKEN0@@} — 2x2 matrix axis pairs by industry. Reference when choosing positioning visualization dimensions.
\end{itemize}
...
\textbf{Review @@TOKEN0@@ and match its professional quality:}
...
\item {} formula = f``=<DCF recalc using \{wacc\_\allowbreak{}value\} and \{term\_\allowbreak{}growth\_\allowbreak{}value\}>''
...
\textbf{This skill uses the @@TOKEN0@@ skill for all spreadsheet operations.} The xlsx skill provides:
...
\textbf{If you encounter errors or unreasonable results, read @@TOKEN0@@ for detailed debugging guidance.}
...
\textbf{Structured Template}
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} scripts/init\_\allowbreak{}skill.py <skill-name> --path <output-directory>
\end{itemize}
...
\textbf{Structured Template}
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} scripts/package\_\allowbreak{}skill.py <path/to/skill-folder>
\end{itemize}
...
\textbf{Structured Template}
\begin{itemize}[leftmargin=*,itemsep=2pt,topsep=2pt]
\item {} scripts/package\_\allowbreak{}skill.py <path/to/skill-folder> ./dist
\end{itemize}
